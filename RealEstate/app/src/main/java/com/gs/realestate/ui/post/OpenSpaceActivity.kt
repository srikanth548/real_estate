...
import com.gs.realestate.databinding.ActivityPostopenBinding

class OpenSpaceActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPostopenBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPostopenBinding.inflate(layoutInflater)
